...
class UserManagementController extends Controller
{
    ...
    {
        $user = User::query()->where('iduser', $id)->firstOrFail();
    ...
    // ================= UPDATE TECHNICIAN =================
    public function updateTechnician(Request $request, int $id)
    {
        $technician = User::query()->where('iduser', $id)->firstOrFail();
