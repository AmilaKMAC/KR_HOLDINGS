            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-start">
                    <div class="form-check">
                        <input class="form-check-input additional-work-check" type="checkbox" id="wire1"
                            value="Ground Mounting Wire">
                        <label class="form-check-label" for="wire1">Ground Mounting Wire</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input additional-work-check" type="checkbox" id="lift1"
                            value="Panel Lifting">
                        <label class="form-check-label" for="lift1">Panel Lifting</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input additional-work-check" type="checkbox" id="angle1"
                            value="Angle Adjust">
                        <label class="form-check-label" for="angle1">Angle Adjust</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input additional-work-check" type="checkbox" id="cable1"
                            value="Extra Cabling">
                        <label class="form-check-label" for="cable1">Extra Cabling</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input additional-work-check" type="checkbox" id="structure1"
                            value="Structure Reinforcement">
                            ...
                            <div class="row g-3">
                                <div class="col-6 col-md-4 col-lg-3">
                                    <img src="https://via.placeholder.com/600x400"
                                        class="img-fluid rounded shadow-sm preview-image" style="cursor:pointer"
                                        alt="Photo">
                                </div>
                                <div class="col-6 col-md-4 col-lg-3">
                                    <img src="https://via.placeholder.com/600x400"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" rows="4" placeholder="Describe the issue clearly..."></textarea>
                    </div>
                </div>
                <div class="modal-footer">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById('saveAdditionalWork').addEventListener('click', function() {
                if (!activeRow) return;
                const selected = [];
                document.querySelectorAll('.additional-work-check:checked').forEach(cb => selected.push(cb
                    .value));
